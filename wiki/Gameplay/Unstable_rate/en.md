...
**Unstable rate** (***UR***) is a measurement of variation of [hit errors](/wiki/Beatmap/Overall_difficulty#timing) throughout a play. It is calculated as the [standard deviation](https://en.wikipedia.org/wiki/Standard_deviation) of hit errors in milliseconds, multiplied by 10. A lower UR indicates that the player's hits have more similar errors, while a higher UR indicates they are more spread apart.
